...
CREATE TABLE IF NOT EXISTS `valor` (
  ...
  `tipo_quarto_id` INT NOT NULL,
  PRIMARY KEY (`calculo`),
  INDEX `fk_valor_tipo_quarto1_idx` (`tipo_quarto_id` ASC) VISIBLE,
...
-- Table `valor`
-- -----------------------------------------------------
INSERT INTO `valor` (`calculo`,`valor_diaria`,`serviço_de_quarto`,`consumiveis`,`tipo_quarto_id`)
VALUES
  (5128976,1599,136,38,4),
  (8065368,828,192,42,3),
  (7128917,1706,48,131,3),
  (2722907,1556,92,41,3),
  (9183738,1326,190,126,2),
  (7666619,1181,22,125,2),
  (5194018,909,69,17,2),
  (3086187,1192,7,62,2),
  (5369456,1338,98,112,3),
  (6134505,1394,40,35,2),
  (9260636,1722,198,74,1),
  (8973174,1973,187,35,3),
  (5285341,872,95,94,2);
